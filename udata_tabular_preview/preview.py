...
class TabularPreview(PreviewPlugin):
    ...
    def can_preview(self, resource):
        ...
        extras_mime = resource.extras.get('analysis:mime-type') or resource.extras.get('check:headers:content-type')
        is_supported = (
        ...
        extras_size = resource.extras.get('analysis:filesize') or resource.extras.get('check:headers:content-length')
        size_ok = (
            not max_size
